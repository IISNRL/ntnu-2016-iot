...
//#define USE_WIFI_SHIELD
    ...
    YunClient client;
      ...
      #include <WiFi.h>
      char ssid[] = "Ryanooo";          //  your network SSID (name) 
      char pass[] = "ryan4559";   // your network password
...
/*
  ...
  *****************************************************************************************/
unsigned long myChannelNumber = 111474;
const char * myWriteAPIKey = "806A4X8E06WKX8UB";
