...
//#define USE_WIFI_SHIELD
    ...
    YunClient client;
      ...
      #include <WiFi.h>
      char ssid[] = "HsTS";          //  your network SSID (name) 
      char pass[] = "e23456789O";   // your network password
...
/*
  ...
  *****************************************************************************************/
unsigned long myChannelNumber = 111489;
const char * myWriteAPIKey = "F7NEDI82QKFJ11RW";
#include <Wire.h>
...
void loop() {
  ...
  int sensorValue = TSL2561.readVisibleLux();
