...
//#define USE_WIFI_SHIELD
    ...
    YunClient client;
      ...
      #include <WiFi.h>
      char ssid[] = "Wlogsky";          //  your network SSID (name) 
      char pass[] = "7777777777";   // your network password
...
/*
  ...
  *****************************************************************************************/
unsigned long myChannelNumber = 111471;
const char * myWriteAPIKey = "S102XUJ6C37M8ZQV";
...
void loop() {
  ...
  float sensorValue = TSL2561.readVisibleLux();
  ...
  ThingSpeak.writeField(myChannelNumber, 1, TSL2561.readVisibleLux(), myWriteAPIKey);
